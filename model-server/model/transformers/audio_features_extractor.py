...
class AudioFeaturesExtractor(TransformerMixin):
    ...
    def transform(self, X):
        ...
        for audio_path in X:
            X_features.append(self.extract_from_audio(audio_path))

        features_pd = pd.DataFrame(X_features)
        return features_pd
    ...
    def extract_from_audio(self, audio_path: str) -> AudioFeatures:
